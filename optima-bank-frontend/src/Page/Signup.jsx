  ...
  return (
    <AuthLayout bgImage="">
      ...
      <form className="grid grid-cols-2 gap-4" onSubmit={handleSubmit}>
        ...
        <input type="text" name="lastName" placeholder="Last Name" onChange={handleChange} value={formData.lastName} className="p-3 rounded-lg outline-none" autoComplete="off" />
